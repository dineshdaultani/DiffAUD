...
class Cifar10(CIFAR10):
    ...
    ATTRIBUTE = {
        'corruption': [
            'jpeg', 'noise', 'blur', 'weak_seq', 'medium_seq', 'strong_seq', 
        ],
        'dataset': 'CIFAR10'
    }
    ...
    def load_annotations(self):
        ...
        for l in load_list:
            ...
            if self.test_mode:
                data_dir = os.path.join(self.data_prefix, c, 'cifar_test')
            else:
                data_dir = os.path.join(self.data_prefix, c, 'cifar_train')

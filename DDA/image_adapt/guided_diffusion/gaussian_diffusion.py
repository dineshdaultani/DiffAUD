...
class GaussianDiffusion:
    ...
    def p_sample_loop_progressive(
        ...
        for i in indices:
            ...
            # DDA Implementation
            difference = resize(resize(model_kwargs["ref_img"], scale_factors=1.0/D, out_shape=shape_d), scale_factors=D, out_shape=shape_u) - \
                                resize(resize(out["pred_xstart"], scale_factors=1.0/D, out_shape=shape_d), scale_factors=D, out_shape=shape_u)
